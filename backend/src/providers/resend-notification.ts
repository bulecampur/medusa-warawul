...
const templates: Record<string, string | ((data: any) => any)> = {
  ...
  "order.ready_for_pickup": orderReadyForPickupEmail,
  "order.canceled": `
    <h1>Order Canceled</h1>
    <p>Your order has been canceled.</p>
  `,
  "customer.signup_verification": customerSignupVerificationEmail,
  "admin.signup_verification": adminSignupVerificationEmail,
  "admin.password_reset": adminPasswordResetEmail,
  "refund.in_process": refundInProcessEmail,
